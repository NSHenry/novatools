...
** Disclaimer
This is just a quick hack that was developed by vekkt0r, only tested by him.
...
** Pre-requisites
- MSP430 toolchain - I included the last released version of osx-launchpad since I was
a TON of trouble compiling from source. This version worked for me on OS X El Capitan 10.11.6
...
- Switch place of the 'Alt' and 'Super' keys to make it easier when swiltching between iOS and OS X devices.
